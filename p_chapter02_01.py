...
car_dicts = [
    {'car_companay':'Ferrai','car_detail':{'color':'White', 'horsepower':400, 'price':8000}},
    {'car_companay':'Bmw','car_detail':{'color':'Black', 'horsepower':270, 'price':5000}},
    {'car_companay':'Audi','car_detail':{'color':'Sliver', 'horsepower':300, 'price':6000}}
]
print(car_dicts)
# pop(key,'default')
del car_dicts[1]
